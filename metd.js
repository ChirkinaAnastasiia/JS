...
// })();
// // alert('Раунд 1. Ты загадываешь количество шариков. Компьютер пытается отгадать чётное или нечётное число ты загадал. Если он угадает, то забирает эти шарики себе, если нет - его шарики достаются тебе. Проиглал тот, у кого не осталось шариков.');
// // alert('Раунд 2. Правила те же, но вы загадываете и отгадываете по очереди!');
// // alert('Раунд 3. Сначала в "камень-ножницы-бумага" решим, кто будет первым загадывать число. Затем играем также, как в предыдущем раунде!');
...
// const startRoundThree = (priority) => {
