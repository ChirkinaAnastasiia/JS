...
// arr.map(item => {
//   if (item.startsWith(answer.toLowerCase())) {
//   answer = item;
//   }
// });
// console.log(answer);
// const finalAnswer = playerAnswer.filter(item => item !== undefined);
...
//       alert(`Вы: ${player}\nКомпьютер: ${computer}\nНичья!`);
//       getPlayerAnswer(prompt(`${answersArray}?`));
//       return foo(playerAnswer, computerAnswer);
//     }
